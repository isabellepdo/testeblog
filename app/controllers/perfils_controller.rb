class PerfilsController < ApplicationController
	...
	def create
		...
		respond_to do |format|
			if @perfil.save
				format.html { redirect_to posts_path, notice: "Perfil atualizado com sucesso." }
	...
	def destroy
		...
		respond_to do |format|
			format.html { redirect_to perfils_url, notice: "Perfil Excluido com Sucesso" }
	...
	private
		...
		def perfil_params
			params.require(:perfil).permit(:user_id, :nome, :idade, :tipo_de_perfil)
		end
end
